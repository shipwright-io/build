...
- Install the Shipwright deployment. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.14.0-rc0/release.yaml --server-side
  curl --silent --location https://raw.githubusercontent.com/shipwright-io/build/v0.14.0-rc0/hack/setup-webhook-cert.sh | bash
...
- Install the Shipwright strategies. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.14.0-rc0/sample-strategies.yaml --server-side
  ```
...
| [v0.14.0-rc0](https://github.com/shipwright-io/build/releases/tag/v0.14.0-rc0)    | [Docs @ v0.14.0-rc0](https://github.com/shipwright-io/build/tree/v0.14.0-rc0/docs) | [Examples @ v0.14.0-rc0](https://github.com/shipwright-io/build/tree/v0.14.0-rc0/samples) |
