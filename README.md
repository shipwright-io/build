...
- Install the Shipwright strategies. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.13.0-rc0/sample-strategies.yaml --server-side
  ```
...
| [v0.13.0-rc0](https://github.com/shipwright-io/build/releases/tag/v0.13.0-rc0)    | [Docs @ v0.13.0-rc0](https://github.com/shipwright-io/build/tree/v0.13.0-rc0/docs) | [Examples @ v0.13.0-rc0](https://github.com/shipwright-io/build/tree/v0.13.0-rc0/samples) |
