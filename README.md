...
- Install the Shipwright deployment. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.15.10/release.yaml --server-side
  curl --silent --location https://raw.githubusercontent.com/shipwright-io/build/v0.15.10/hack/setup-webhook-cert.sh | bash
  curl --silent --location https://raw.githubusercontent.com/shipwright-io/build/v0.15.10/hack/storage-version-migration.sh | bash
  ```
...
- Install the Shipwright strategies. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.15.10/sample-strategies.yaml --server-side
  ```
...
| [v0.15.10](https://github.com/shipwright-io/build/releases/tag/v0.15.10)    | [Docs @ v0.15.10](https://github.com/shipwright-io/build/tree/v0.15.10/docs) | [Examples @ v0.15.10](https://github.com/shipwright-io/build/tree/v0.15.10/samples) |
