...
- Install the Shipwright deployment. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.16.8/release.yaml --server-side
  curl --silent --location https://raw.githubusercontent.com/shipwright-io/build/v0.16.8/hack/setup-webhook-cert.sh | bash
  curl --silent --location https://raw.githubusercontent.com/shipwright-io/build/v0.16.8/hack/storage-version-migration.sh | bash
  ```
...
- Install the Shipwright strategies. To install the latest version, run:
  ...
  ```bash
  kubectl apply --filename https://github.com/shipwright-io/build/releases/download/v0.16.8/sample-strategies.yaml --server-side
  ```
