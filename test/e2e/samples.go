...
// TestAll iterate through test cases, sorting by name.
func (s *SamplesTesting) TestAll(testCases map[string]*SampleFiles) {
	...
	for _, testName := range testNames {
		s.t.Logf("Running tests: '%s'", testName)
		s.Test(testName, testCases[testName])
	}
}
