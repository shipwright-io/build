...
func (t *TestBuild) CreateBuild(build *buildapialpha.Build) error {
...
func (t *TestBuild) GetBuild(name string) (*buildapialpha.Build, error) {
...
func (t *TestBuild) ListBuilds(namespace string) (*buildapialpha.BuildList, error) {
...
func (t *TestBuild) PatchBuild(buildName string, data []byte) (*buildapialpha.Build, error) {
...
func (t *TestBuild) PatchBuildWithPatchType(buildName string, data []byte, pt types.PatchType) (*buildapialpha.Build, error) {
	bInterface := t.BuildClientSet.ShipwrightV1alpha1().Builds(t.Namespace)
...
func (t *TestBuild) GetBuildTillValidation(name string) (build *buildapialpha.Build, err error) {
...
// it´s registered field. If timeout is reached or an error is found, it will
// return with an error
func (t *TestBuild) GetBuildTillRegistration(name string, condition corev1.ConditionStatus) (*buildapialpha.Build, error) {
...
func (t *TestBuild) GetBuildTillMessageContainsSubstring(name string, partOfMessage string) (*buildapialpha.Build, error) {
