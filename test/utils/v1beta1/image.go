...
func (t *TestBuild) getRegistryAuthentication(
	...
	if buildRun.Spec.Output != nil && buildRun.Spec.Output.PushSecret != nil {
		secretName = *buildRun.Spec.Output.PushSecret
	} else if buildRun.Status.BuildSpec.Output.PushSecret != nil {
		secretName = *buildRun.Status.BuildSpec.Output.PushSecret
	}
