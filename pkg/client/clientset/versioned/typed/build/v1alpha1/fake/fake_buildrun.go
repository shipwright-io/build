...
var buildrunsResource = v1alpha1.SchemeGroupVersion.WithResource("buildruns")

var buildrunsKind = v1alpha1.SchemeGroupVersion.WithKind("BuildRun")
...
func (c *FakeBuildRuns) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BuildRun, err error) {
	...
	return obj.(*v1alpha1.BuildRun), err
}
...
func (c *FakeBuildRuns) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BuildRunList, err error) {
	...
	list := &v1alpha1.BuildRunList{ListMeta: obj.(*v1alpha1.BuildRunList).ListMeta}
	for _, item := range obj.(*v1alpha1.BuildRunList).Items {
...
func (c *FakeBuildRuns) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(buildrunsResource, c.ns, name, opts), &v1alpha1.BuildRun{})
