...
import (
	...
	build "github.com/shipwright-io/build/pkg/client/informers/externalversions/build"
...
type SharedInformerFactory interface {
	...
	Shipwright() build.Interface
}

func (f *sharedInformerFactory) Shipwright() build.Interface {
