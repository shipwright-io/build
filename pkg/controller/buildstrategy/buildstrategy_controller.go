...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner BuildStrategy
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &buildv1alpha1.BuildStrategy{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBuildStrategy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the BuildStrategy instance
	instance := &buildv1alpha1.BuildStrategy{}
	...
	// Set BuildStrategy instance as the owner and controller
...
func newPodForCR(cr *buildv1alpha1.BuildStrategy) *corev1.Pod {
