...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPBuildSource) DeepCopyInto(out *HTTPBuildSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPBuildSource.
func (in *HTTPBuildSource) DeepCopy() *HTTPBuildSource {
	if in == nil {
		return nil
	}
	out := new(HTTPBuildSource)
