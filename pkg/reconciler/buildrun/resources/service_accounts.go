	...
	case apierrors.IsNotFound(err):
		...
		serviceAccount = &corev1.ServiceAccount{
			ObjectMeta: metav1.ObjectMeta{
				Name:      GetGeneratedServiceAccountName(buildRun),
				Namespace: buildRun.Namespace,
				Labels:    map[string]string{buildv1beta1.LabelBuildRun: buildRun.Name},
				OwnerReferences: []metav1.OwnerReference{
					*metav1.NewControllerRef(buildRun, buildv1beta1.SchemeGroupVersion.WithKind("BuildRun")),
				},
			},
...
// to use on BuildRuns
func getDefaultNamespaceSA(ctx context.Context, client client.Client, buildRun *buildv1beta1.BuildRun) (*corev1.ServiceAccount, error) {
