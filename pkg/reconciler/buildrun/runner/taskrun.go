...
func (t *TaskRunBuildRunner) SyncBuildRunStatus(ctx context.Context, client client.Client, buildRun *v1beta1.BuildRun) error {
	...
	if len(t.Status.Results) > 0 {
		...
		updateBuildRunStatusWithSourceResult(buildRun, t.Status.Results)
		updateBuildRunStatusWithOutputResult(buildRun, t.Status.Results)
	}
...
func updateBuildRunStatusWithSourceResult(buildrun *v1beta1.BuildRun, results []pipelineapi.TaskRunResult) {
...
func updateBuildRunStatusWithOutputResult(buildRun *v1beta1.BuildRun, taskRunResult []pipelineapi.TaskRunResult) {
