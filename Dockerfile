...
WORKDIR /go/src/github.com/shipwright-io/build-operator
...
COPY --from=builder /go/src/github.com/shipwright-io/build-operator/build/_output/bin/build-operator /usr/local/bin/build-operator
